...
<%
	...
	ps1.setInt(1, Integer.parseInt(request.getParameter("empid")));
	...
	PreparedStatement ps = con.prepareStatement("insert into timesheetlog (empid,fromdate,todate,status,comment,updatedby) values(?,?,?,?,?,?)");
	ps.setInt(1, Integer.parseInt(request.getParameter("empid")));
	ps.setString(2, fromdate);
	ps.setString(3, todate);
